namespace Bit.Logger.Tests
{
    ...
    public class DefaultSourcesShould
    {
        private readonly Mock<ILogger> sut;

        public DefaultSourcesShould()
        {
            sut = new Mock<ILogger>(MockBehavior.Strict);

            sut.SetupCalls().Setup(logger =>
                logger
                    .AddConsoleSource(Config.Console)
                    .AddDatabaseSource(Config.Database)
                    .AddFileSource(Config.File)
            );
        }

        [Fact]
        public void Not_LogMessage_AsTrace_OncePerMethodOverload()
        {
        ...
        [Fact]
        public void Not_LogMessage_AsDebug_OncePerMethodOverload()
        {
        ...
        [Fact]
        public void Not_LogMessage_AsVerbose_OncePerMethodOverload()
        {
        ...
        [Fact]
        public void Not_LogMessage_AsInformation_OncePerMethodOverload()
        {
        ...
        [Fact]
        public void Not_LogMessage_AsWarning_OncePerMethodOverload()
        {
        ...
        [Fact]
        public void Not_LogMessage_AsError_OncePerMethodOverload()
        {
        ...
        [Fact]
        public void Not_LogMessage_AsCritical_OncePerMethodOverload()
        {
